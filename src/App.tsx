...
import { AboutUs } from './pages/components/services/AboutUs/AboutUs';
import { PatientPage } from './pages/components/PatientPage/PatientPage';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        />
        <Route path='/for-patients' element={<PatientPage />} />
